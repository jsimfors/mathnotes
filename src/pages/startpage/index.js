      ...
      <div className="row">
        <div className="col-md-12">
          <div className="inner-content" id="startpage">
            ...
            <br/>
            <br/>
            <u>Här</u> hittar ni även mitt sammanfattade teorihäfte för hela kursen! 
            <br/>
            <u>Här</u> hittar ni lite allmäna pluggtips och bra länkar för just SF1624! 
            <br/>
            <br/>
            Behöver ni kontakta mig kan ni göra det på simfors@kth.se
