...
const Startpage = () => (
  <div className="inner-content startpage">
    <div className="inner-header">Välkommen till SF19XY Sannolikhetsteori &amp; Statistik</div>
      ...
      Så ni som använder den kommer åt det där! :) obs inte reklam eller nåt lol, ville bara tipsa! Har ändå lagt ner hjärta och själv i de där sammanfattningarna! 
